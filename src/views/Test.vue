      ...
      <div class="section">
        <div class="container">
          <div class="md-layout">
            ...
            >
              <h2 class="title text-center">This is main page</h2>
              <h5 class="description">
                This is the test page. I will exercise several things in this page.
              </h5>
            </div>
          </div>
        <div>
            <h2 class="title text-center">Page link</h2>
            <h5 class="description text-center">
                <a href="#/test2">go to paper summary page</a>
            </h5>
        </div>
